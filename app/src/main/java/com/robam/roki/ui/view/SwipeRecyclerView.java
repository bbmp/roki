            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (mPosition != INVALID_POSITION) {
                    ...
                    if (view != null && mFlingView != view && view.getScrollX() != 0) {
                        TranslateAnimation animation = new TranslateAnimation( 0,view.getScrollX(), 0, 0);
...
//            mFlingView.scrollTo(0, 0);
            TranslateAnimation animation = new TranslateAnimation(mFlingView.getScrollX(), 0, 0, 0);
            animation.setDuration(2000);
            mFlingView.startAnimation(animation);
        }
    }
}